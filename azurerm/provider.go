...
func Provider() terraform.ResourceProvider {
	...
	p = &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"azurerm_cosmos_db_account":                      dataSourceArmCosmosDBAccount(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"azurerm_cosmos_db_account":                        resourceArmCosmosDBAccount(),
			...
			"azurerm_load_balancer_backend_address_pool":                 resourceArmLoadBalancerBackendAddressPool(),
			"azurerm_load_balancer_nat_rule":                             resourceArmLoadBalancerNatRule(),
			"azurerm_load_balancer_nat_pool":                             resourceArmLoadBalancerNatPool(),
			"azurerm_load_balancer_probe":                                resourceArmLoadBalancerProbe(),
			"azurerm_load_balancer_rule":                                 resourceArmLoadBalancerRule(),
